...
interface AdminRegisterFormProps {
  onCodeRequested: (email: string) => void; // Definimos la propiedad onCodeRequested
}

const AdminRegisterForm: React.FC<AdminRegisterFormProps> = ({ onCodeRequested }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/admin/request-code`, {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        // Llamamos a onCodeRequested con el email
